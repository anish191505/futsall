...
<?php include("../includes/footsalnavbar.php"); ?>
<style>
    .bookings {
        color: #ff7200;
    }
...
<center>
    <table>
        ...
        <?php
        $getBookings = $con->query("SELECT * FROM footsal.bookings where companyId='$footsalID'  ORDER BY id DESC ");
        ...
        <a class='delete' href='delete-booking.php?id=$orderId'><center>Delete</center></a>";
            if ($status != "accepted") {
                echo "  <a class='delete' style='color:green;' href='accept-booking.php?id=$orderId'><center>Accept</center></a>";
            }
            echo "
        </td>
